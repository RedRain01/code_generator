package com.ys.code.provider.db.table.model;



import java.util.List;

import com.ys.code.generator.GeneratorProperties;
import com.ys.code.provider.db.table.model.ForeignKey.ReferenceKey;
import com.ys.code.provider.db.table.model.util.ColumnHelper;
import com.ys.code.util.GLogger;
import com.ys.code.util.StringHelper;
import com.ys.code.util.TestDataGenerator;
import com.ys.code.util.typemapping.ActionScriptDataTypesUtils;
import com.ys.code.util.typemapping.DatabaseDataTypesUtils;
import com.ys.code.util.typemapping.JavaPrimitiveTypeMapping;
...
public class Column implements java.io.Serializable, Cloneable {
    ...
    public String getColumnName() {
        if (columnName.startsWith("F")) {
            return StringHelper.capitalize(columnName.substring(1));
        }
        return columnName;
    }
    ...
    /**
     * 得到尽可能简短的javaType的名称，如果是java.lang.String,将返回String, 如com.company.model.UserInfo,将返回
     * com.company.model.UserInfo
     * 
     * @return
     */
