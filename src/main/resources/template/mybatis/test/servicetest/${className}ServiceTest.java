...
<#assign propertyName = classNameLower+"Service">
...
import com.ys.credit.backed.protocol.service.${className}Service;
...
public class ${className}ServiceTest {
	...
	@Autowired
	private ${className}Service ${propertyName};
...
<#if table.hasPk>
	...
	<#list table.columns as column>		
		...
		<#elseif column.possibleShortJavaType == "java.math.BigDeciaml">
